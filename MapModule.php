...
class MapModule extends CWebModule {
	...
	private $_keywords = "Map, Maperability, module,opensource,CO,communecter";
	private $_description = "Un module pour Mapérer avec divers base de données";
	private $_pageTitle = "Map";
